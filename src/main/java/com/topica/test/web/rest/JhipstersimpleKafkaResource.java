...
@RestController
@RequestMapping("/api/jhipstersimple-kafka")
public class JhipstersimpleKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipstersimpleKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipstersimpleKafkaResource(KafkaProperties kafkaProperties) {
